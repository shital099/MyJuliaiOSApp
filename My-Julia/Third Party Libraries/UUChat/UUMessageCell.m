...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.labelMessageTime = [[UILabel alloc] init];
        self.labelMessageTime.textAlignment = NSTextAlignmentRight;
        self.labelMessageTime.textColor = [UIColor grayColor];
        self.labelMessageTime.font = ChatTimeFont;
        [self.contentView addSubview:self.labelMessageTime];

        self.bgSelectionImage = [[UIImageView alloc] init];
        self.bgSelectionImage.backgroundColor = [UIColor colorWithRed:133.0/255.0 green:193.0/255.0 blue:233.0/255.0 alpha:7.0];
        self.bgSelectionImage.alpha = 0.4;
        self.bgSelectionImage.hidden = true;
        [self.contentView addSubview:self.bgSelectionImage];
...
-(void)setUIControls {
    ...
    headImageBackView.layer.cornerRadius = 22;
    headImageBackView.layer.masksToBounds = YES;
    headImageBackView.backgroundColor = [[UIColor redColor] colorWithAlphaComponent:0.4];
    [self.contentView addSubview:headImageBackView];
    self.btnHeadImage = [UIButton buttonWithType:UIButtonTypeCustom];
    self.btnHeadImage.layer.cornerRadius = 20;
    self.btnHeadImage.layer.masksToBounds = YES;
...
//    
//    messageFrame.screen_size = self.frame.size;
//
//    //Update message frame(All content inside cell)
...
//   // [self.btnHeadImage setBackgroundImageForState:UIControlStateNormal withURL:[NSURL URLWithString:message.strIcon] placeholderImage:[UIImage imageNamed:@"user.png"]];
//    
//    // 3、设置下标
...
- (void)setMessagesFrame:(UUMessageFrame *)messageFrame {
    ...
    self.bgSelectionImage.frame = messageFrame.bgImageF;
    ...
    if (messageFrame.nameF.origin.x > 160) {
        ...
        self.labelNum.frame = CGRectMake(messageFrame.nameF.origin.x, messageFrame.nameF.origin.y + 3, 150, messageFrame.nameF.size.height);
        self.labelNum.textAlignment = NSTextAlignmentLeft;
    }
    ...
    self.labelMessageTime.text = message.messageTime;
    self.labelMessageTime.frame = messageFrame.contentTimeF;
    ...
    //[self.btnContent setBackgroundImage:[normal imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateNormal];
   // [self.btnContent setBackgroundImage:[normal imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateHighlighted];
    //[self.btnContent setTintColor:[UIColor redColor]];
    ...
    switch (message.type) {
        ...
        case UUMessageTypePicture:
        {
            self.btnContent.backImageView.hidden = NO;
//            self.btnContent.backImageView.image = message.picture;
            NSLog(@"Picture String : %@",message.pictureString);
            [self.btnContent.backImageView sd_setImageWithURL:[NSURL URLWithString: message.pictureString]
