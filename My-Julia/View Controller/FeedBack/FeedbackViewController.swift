...
//        if model.questionType == "Multiple" {
//
//            let cell = tableView.dequeueReusableCell(withIdentifier: "FeedbackCustomCell", for: indexPath) as! FeedbackCustomCell
//            cell.backgroundColor = cell.contentView.backgroundColor;
//
//            let optionDict = model.optionsArr[indexPath.row] as! NSDictionary
//            cell.optionLabel.text = optionDict["OptionValue"] as? String
//            cell.optionLabel.accessibilityIdentifier = optionDict["OptionId"] as? String
//
//            //            let key = "Option" + String(indexPath.row+1)
//            //            let optionDict = model.optionText as Dictionary
//            //            cell.optionLabel.text = optionDict[key] as? String
